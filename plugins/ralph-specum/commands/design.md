...
<mandatory>
**BEFORE proceeding with design, check if there's an orphaned execution loop.**
...
2. **STOP** - Do NOT continue with design phase. Wait for user to handle the orphaned execution.
