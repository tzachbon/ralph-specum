...
<mandatory>
**BEFORE creating a new spec, check if there's an orphaned execution loop.**
...
2. **STOP** - Do NOT continue with new spec creation. Wait for user to handle the orphaned execution.
