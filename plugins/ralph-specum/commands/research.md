...
<mandatory>
**BEFORE proceeding with research, check if there's an orphaned execution loop.**
...
2. **STOP** - Do NOT continue with research phase. Wait for user to handle the orphaned execution.
